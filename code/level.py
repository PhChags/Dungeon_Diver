...
class Level:
	...
	def run(self):
		...
		if self.game_paused:
			...
			return game_over(self.player.points);
		elif self.visible_sprites.enemy_check_all_deaths():
			return win_screen(self.player.points);
		else:
...
class YSortCameraGroup(pygame.sprite.Group):
	...
	def enemy_check_all_deaths(self):
		enemy_sprites = [sprite for sprite in self.sprites() if hasattr(sprite,'sprite_type') and sprite.sprite_type == 'enemy'];
		for enemy in enemy_sprites:
			if not enemy.check_death():
				return False;
		return True;
